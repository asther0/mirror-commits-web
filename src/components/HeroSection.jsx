      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
        <div className="flex flex-col lg:grid lg:grid-cols-2 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left mb-10 lg:mb-0">
            ...
            <p className="text-base sm:text-lg text-slate-500 mb-8 max-w-lg mx-auto lg:mx-0 animate-fade-in-up animation-delay-100 text-balance">
            ...
            <div className="flex justify-center lg:justify-start gap-6 mt-6 animate-fade-in-up animation-delay-300">
              <span className="text-sm text-slate-400">Corre en tu terminal</span>
              <span className="text-slate-200">|</span>
              <span className="text-sm text-slate-400">No sube tu código</span>
              <span className="text-slate-200">|</span>
              <span className="text-sm text-slate-400">Solo copia fechas</span>
            </div>
          </div>
