      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col lg:grid lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left mb-12 lg:mb-0">
            ...
            <p className="text-base sm:text-lg text-slate-500 mb-8 max-w-md mx-auto lg:mx-0 animate-fade-in-up animation-delay-100 text-balance">
            ...
            <div className="flex justify-center lg:justify-start gap-6 mt-8 animate-fade-in-up animation-delay-300">
